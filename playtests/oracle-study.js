...
labels.forEach(L=>{
  ...
  console.log('  small '+col(R=>pc(R.small))+'   progress: a brew · aging · Ready · a commission · a load · a die +1 · the dividend · the Hop merchant · the yard · a bonus · a building stop');
  ...
  console.log('  casks a seat: brews '+col(R=>f1(R.ev.brews))+' (Gruit '+col(R=>f1(R.ev.gruit))+') · loads '+col(R=>f1(R.ev.loads))+' · yard carts '+col(R=>f1(R.ev.yard))+' · presents '+col(R=>f1(R.ev.hall))+' · never left the brewery '+col(R=>f1(R.neverLeft))+' · posts '+col(R=>f1(R.ev.post))+' · die +1 '+col(R=>f1(R.ev.raise))+' · Market visits '+col(R=>f1(R.ev.market))+' · Ships commissioned a game '+col(R=>f1(R.comms))+' → sailed '+col(R=>f1(R.sailed)));
