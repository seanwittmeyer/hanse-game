...
const VENTURES=[
  {k:'rack',     l1:{nm:'Rack House',     ic:'repeat',  pub:VPUB_STEP, own:VBIG(LU('dices')), txt:'Swap 2 dice', art:'venture-rack-l1.png'},
  ...
  {k:'warehouse',l1:{nm:'Warehouse',      ic:'boxes',   pub:VPUB_GOLD, own:VBIG(LU('package-plus')), txt:'On load, load another', art:'venture-warehouse-l1.png'},
                 l2:{nm:'Guild Residence',ic:'home',    pub:VPUB_SH1, trig:'At end', own:VBIG(LU('star-plus2','starmark'))+VSEP('×')+VBIG(LU('home')), art:'venture-warehouse-l2.png'}},
];
