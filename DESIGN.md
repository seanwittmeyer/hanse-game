...
- ⚙ Open: whether the cask-action pool is too rich (the pace cause), whether Wild-at-Q4+ is the right gate, the loader bonus size, and the clock retune.
