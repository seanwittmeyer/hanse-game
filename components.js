...
+'.btile .vt-pub{position:absolute;right:-.05in;bottom:-.05in;z-index:3;display:flex;align-items:center;justify-content:center;width:.64in;height:.74in;background:rgba(255,255,255,.2);border:1px solid rgba(255,255,255,.45);border-radius:.09in;padding:0;margin:0}'
...
+'.btile .vt2{align-items:center;gap:.05in;padding-right:.66in}'
...
+'.btile .vt-pub .ic,.btile .vt-pub img.ai,.btile .vt-pub svg{width:.42in;height:.42in}'
