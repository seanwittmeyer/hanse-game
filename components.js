...
const BUILDINGS=[
  ...
  {k:'granary',   nm:'Granary',           verb:'transform', tgt:'act',  ic:'coins',        n:1, act:'source', eff:'Slot stop: gain 2 goods (any mix)', art:'building-staple.png'},
  {k:'scriveners',nm:'Scrivener’s Hall',  verb:'transform', tgt:'act',  ic:'scroll-text',  n:1, g:1, act:'recipe', eff:'Slot stop: gain 1 recipe (at its fee)', art:'building-gauger.png'},
  ...
  {k:'racking',   nm:'Racking Hall',      verb:'transform', tgt:'act',  ic:'repeat',       n:1, g:3, act:'rack',   eff:'Slot stop: swap the dice of ANY two of your vessel casks — no quality cap (the beer transfers; cap 6)', art:'building-partigyle.png'},
  {k:'assay',     nm:'Assay House',       verb:'transform', tgt:'act',  ic:'scale',        n:1, g:1, act:'assay',  eff:'Slot stop: turn one of your maturing dice ±1 (≤ its quality, ≥ 1)', art:'building-connoiss.png'},
  {k:'abbey',     nm:'Abbey Cellar',      verb:'transform', tgt:'act',  ic:'hourglass',    n:1, g:2, act:'abbey',  eff:'Slot stop: pay 3'+LU('sprout','h')+' — ALL your maturing casks age to READY', art:'building-festkeller.png'},
  {k:'hopex',     nm:'Hop Exchange',      verb:'transform', tgt:'act',  ic:'sprout',       n:1, g:2, act:'hopex',  eff:'Slot stop: pay up to 2'+LU('sprout','h')+' — turn your vessel dice +1 per hop (past quality is fine; cap 6)', art:'building-hopyard.png'},
  {k:'maltkiln',  nm:'Malt Kiln',         verb:'transform', tgt:'cask', ic:'flame',        n:2, g:2, eff:'A cask loading here: die +1 (cap 6)'},
  {k:'tollhouse', nm:'Tollhouse',         verb:'transform', tgt:'cask', ic:'ticket',       n:1, g:1, eff:'A cask loading here may turn its die −1 (never below the gate): bank +3★ at once', art:'building-burgomstr.png'},
  {k:'bonded',    nm:'Bonded Store',      verb:'transform', tgt:'cask', ic:'warehouse',    n:1, g:2, art:'building-salthouse.png', eff:'A cask loading here: die +1 (cap 6). When this hull sails, the Store sails with it (boxed) — every house with a cask aboard gains 2 goods'},
  {k:'cooperage', nm:'Cooperage',         verb:'transform', tgt:'ship', ic:'package',      n:1, g:2, eff:'Ship here carries +1 berth'},
  {k:'customs',   nm:'Customs House',     verb:'transform', tgt:'ship', ic:'scroll-text',  n:1, g:2, eff:'Ship here boards one gate lower'},
...
function buildingCard(d){const foot=(d.verb==='value'?PRIV_FOOT:WORK_FOOT);
  ...
  +'<div class="bt-foot"><span class="bt-eff">'+d.eff+'</span><span class="bt-cost">'+cost(d.g,d.h)+'</span></div>'
  +'</div>';}
