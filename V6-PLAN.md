...
split on the diagonal into **row/column worker halves** (each half prints its partner's
mark; the standing pawn records the worked line — app board + print board, no mechanic
