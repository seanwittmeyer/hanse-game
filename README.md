...
> **✅ v0.10 is live repo-wide:** the markdown specs **and all four HTML pages** are on v0.10 "The Wharf." (The playable `play.html` adds one engine-level relief valve, the **Charter** — an escalating-fare (`2 G` +1/charter, max `5 G`) single-cask Harbor voyage that keeps the tight slots from deadlocking; see `RULES.md` §5.)
