...
const BUILDINGS=[
  ...
  {k:'racking',   nm:'Racking Hall',      verb:'transform', tgt:'act',  ic:'repeat',       n:1, g:1, act:'rack',   eff:'Slot stop: swap the dice of two of your maturing casks (each stops at its quality)', art:'building-partigyle.png'},
  {k:'assay',     nm:'Assay House',       verb:'transform', tgt:'act',  ic:'scale',        n:2, h:1, act:'assay',  eff:'Slot stop: turn one of your maturing dice ±1 (≤ its quality, ≥ 1)', art:'building-connoiss.png'},
  {k:'maltkiln',  nm:'Malt Kiln',         verb:'transform', tgt:'cask', ic:'flame',        n:2, g:2, eff:'A cask loading here: die +1 (cap 6)'},
  {k:'hopex',     nm:'Hop Exchange',      verb:'transform', tgt:'cask', ic:'sprout',       n:1, g:1,h:1, eff:'A cask loading here may pay 1'+LU('sprout','h')+': die +1 (cap 6)', art:'building-hopyard.png'},
  {k:'tollhouse', nm:'Tollhouse',         verb:'transform', tgt:'cask', ic:'ticket',       n:1, g:1, eff:'A cask loading here may turn its die −1 (never below the gate): bank +2★', art:'building-burgomstr.png'},
  {k:'bonded',    nm:'Bonded Store',      verb:'transform', tgt:'cask', ic:'warehouse',    n:1, g:1,h:1, art:'building-salthouse.png', eff:'A cask loading here: die +1 (cap 6). When this hull sails, the Store sails with it (boxed) — every house with a cask aboard gains 2 goods'},
