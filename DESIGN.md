...
- **ONE green building family** — no owner: every building serves whoever activates it; the
  placer banks **+3★**. **The box prints 20 ⚙ — setup deals 17 (v4.6; ≥1 Kiln + ≥1 Mission
...
- **Everything is earned, not bought** — recipes (Bruges · bonuses · Scrivener’s), buildings
  (London · bonuses), specialists (Bergen — **every house with a cask aboard seats one, max
  1 per house per ship**, v4.6b · Hiring Post ·
...
- **Specialist** — the purple private tile (13 designs — v4.6: the core 5 at max(2, n−1)
  ...
  (**every shipping house seats one — max 1 per house per ship**, v4.6b); the Hiring Post /
  hire bonus pay the tile's **printed wharf fee** (v4.2).
