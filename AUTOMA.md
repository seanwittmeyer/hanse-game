...
>
> **STATUS — Phases 1 & 2 SHIPPED (2026-06-11, `play.html` `KEY → v23`).**
...
> Harnesses: `ai-ladder.js` (ladder + mixed-table gates) · `ai-render-smoke.js` (real render layer) · `ai-tune.js` (weight re-tuning). Details: `CHANGELOG.md` "AI opponents — Phase 1 / Phase 2". **Phase 3 (Monte Carlo "Guildmaster") remains open.**
