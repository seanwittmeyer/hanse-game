...
| the second runnings | n | The Brewhouse's ALTERNATE (designer-panel 2026-08-31): a second Brew that takes the beer's stack's **TOP tile, as it lies** — the stacks are face-up, so the cost is **no choice, not no information** (never "blind") | literal parti-gyle: the same grammar as Zerbster's zgyle bonus; *the double kettle* stays the station's nickname |
