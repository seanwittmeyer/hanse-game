...
2. **The Wharf & the lean** — does it keep the Gain→Brew→Age→Ship flow legible, and does it shift the volume-vs-prestige lean? That's the heart; keep it medium-weight (interesting choices, not mental burden).
...
battery, 59 checks in 15 groups, seconds) and `playtests/sim.js` (the v8 usage counters,
