# Components — the v5.8 body and the v7 kit deltas (pre-v8)

*Cut whole from `COMPONENTS.md` §§1–11 on 2026-09-07 (the repo re-cut). The root `COMPONENTS.md` is now the plain v8 manifest; this is the detailed v5.8 body with every kit delta through v7.0b, kept as reference. Nothing here is live.*
