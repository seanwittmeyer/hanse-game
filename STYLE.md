...
| ~~the walk~~ | — | RETIRED at v6.3 — the turn frame is again the v5 **line activation** (MOVE adjacent · row/column · stops), so *line* (§4) is the word; the stations print **PRIMARY / ALTERNATE** single verbs (Market Source 3/Chart · Brewhouse Brew/Trade · Harbor Commission/Load-any · Cellar Age 3/Sail) | ✕ v6.3 |
