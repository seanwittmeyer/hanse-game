...
|---|---|---|---|---|
| **Bruges** (Hub) | Q1 | low (+2) | light **2 / 1 / 1** | **gain 2 goods** (liquidity) — takes any beer, the volume on-ramp |
| **London** (Steelyard) | Q2 | mid (+3) | mid **3 / 1 / 1** | **take 1 Upgrade from the face-up display** (§3) — *the engine destination* (accessible upgrades) |
| **Bergen** (Bryggen) | Q2 | mid (+3) | rich **4 / 2 / 1** | **gain 2 goods** (liquidity) — the rich-majority kontor |
| **Novgorod** (Long Haul) | Q3 | **high (+5)** | richest **5 / 2 / 1** | **take 1 Upgrade from the display** — premium only; pays the most *and* a perk |
| **The Hall** (Prestige) | Q2 | **prestige ∝ quality (Q×2)** | — | *(none)* — out of commerce (the scarcity/Westvleteren lean) |

- **Benefits pair off: liquidity vs the engine.** **Bruges & Bergen** each hand the owner **2 goods** on delivery (liquidity); **London & Novgorod** each let the owner **take one tile from the Market's shared face-up Upgrade display** (§3) — *free*, where buying it would cost goods. Because the display is a small, churning row, **you don't fully know which Upgrade will be on offer when your cask arrives** — that uncertainty is the point. **London is the *engine* destination** (the accessible Q2 upgrade kontor); **Bergen** pairs its rich majority with goods, so the two stay distinct.
- **Every kontor pays a tiered, ranked majority (Lacerda-style), laddered by reach:** at each kontor, count delivered casks; **1st/2nd/3rd place take the destination's majority tiers**. The harder a kontor is to reach, the richer its majority — **Bruges 2/1/1 · London 3/1/1 · Bergen 4/2/1 · Novgorod 5/2/1** ⚙ — so the majority *lean* is a live choice at all four (commit to one or two, deny the scatter-shipper its 1st places), not just one. **In a 2-player game, 2nd place is skipped** (winner-take-all at each kontor). Tied players split the sum of the tiers they collectively occupy ⚙. Presence at a kontor = your delivered casks there. *(The ladder is kept modest and steep — rich 1st, thin 2nd/3rd — so a broad volume shipper can't harvest majority points everywhere as a byproduct; sim-validated that volume / prestige / majority all land near fair, `DESIGN.md` §21 v0.10.)*
...
2. **Majorities** — the **tiered, ranked** route-majority at *every* kontor: by delivered-cask count, **1st/2nd/3rd place take that kontor's majority tiers**, laddered by reach (§5 — Bruges 2/1/1 · London 3/1/1 · Bergen 4/2/1 · Novgorod 5/2/1 ⚙). **2-player games skip 2nd** (winner-take-all); tied players split the sum of the tiers they occupy ⚙.
