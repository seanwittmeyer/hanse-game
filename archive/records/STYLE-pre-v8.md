# Term registry — the pre-v8 entries

*Cut from `STYLE.md` on 2026-09-07 (the repo re-cut): the v5 noun and verb tables as they stood (with their retired rows), the applied decisions (§4), the v4.15 provisional entries (§4b), the v6 family (§4d) and the v7 family (§4e). The root `STYLE.md` is now the v8 registry alone. Reference only.*

---

## The v5 noun and verb tables, as they stood
