...
**Live build: v5.5 “Four Hands” (`KEY hanse-v55`, designer-ruled 2026-08-23).** The complete version history and rationale live in **`DESIGN.md` §9** (v5 letters in detail, pre-5.0 as a digest); the live watch-list in **`DESIGN.md` §10**; the consolidated v5 decision record in `archive/records/V5-DECISIONS.md`. Gates at v5.5: verify **382/382** · sim clean (0 crashes / 0 deadlocks) · render-smoke ALL PASS · aid ALL FIT. **LIVE PACE WATCH:** with the v5.5 dead-stop fix the family finally all fires and the game runs FAST — 2p 12.0 (50% in band), 3p 14.4, 4p 12.8. The tray (13 ⚙) is the dial and it is the designer's call (`DESIGN.md` §10).
