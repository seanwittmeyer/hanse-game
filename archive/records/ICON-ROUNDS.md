# The icon program — the production record and the pre-art manifest

*The whole of `art/ICONS.md` as it stood on 2026-09-07, moved here at the repo re-cut. The root `art/ICONS.md` is now a short accounting of the icons the pages can use; this keeps the sixteen rounds of the 2026-08 icon program and the Lucide → PNG inventory it worked from. Reference only.*
